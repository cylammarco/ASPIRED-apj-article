...
dmwd_red_1_twodspec.ap_extract(
    spec_id=[1], apwidth=8, skysep=[3, 15], display=False
)
dmwd_red_1_twodspec.ap_extract(
    spec_id=[2], apwidth=8, skysep=[15, 3], display=False
)
...
if version.parse(aspired.__version__) > version.parse("0.5"):
    ...
    """
    np.savetxt(
        "dolores-red-pixel-wavelength-solution-pairs.txt",
        np.column_stack(
            [
                dmwd_red_1_onedspec.science_spectrum_list[0].calibrator.matched_peaks,
                dmwd_red_1_onedspec.science_spectrum_list[0].calibrator.matched_atlas,
            ]
        ),
        delimiter=",",
    )
    ...
    np.savetxt(
        "dolores-red-effective-pixel-spectrum.txt",
        np.column_stack(
            [
                dmwd_red_1_onedspec.science_spectrum_list[0].pixel_list,
                dmwd_red_1_onedspec.science_spectrum_list[0].arc_spec,
            ]
        ),
        delimiter=",",
    )
    """
    np.savetxt(
        "dolores-blue-pixel-wavelength-solution-pairs.txt",
        np.column_stack(
            [
                dmwd_blue_1_onedspec.science_spectrum_list[0].calibrator.matched_peaks,
                dmwd_blue_1_onedspec.science_spectrum_list[0].calibrator.matched_atlas,
            ]
        ),
        delimiter=",",
    )
    ...
    np.savetxt(
        "dolores-blue-effective-pixel-spectrum.txt",
        np.column_stack(
            [
                dmwd_blue_1_onedspec.science_spectrum_list[0].pixel_list,
                dmwd_blue_1_onedspec.science_spectrum_list[0].arc_spec,
            ]
        ),
        delimiter=",",
    )
