...
dmwd_red_1_twodspec = spectral_reduction.TwoDSpec(dmwd_red_1_image_reduction,
...
dmwd_red_2_twodspec = spectral_reduction.TwoDSpec(dmwd_red_2_image_reduction,
                                                  spatial_mask=spatial_mask,
                                                  spec_mask=spec_mask_red,
                                                  cosmic=True,
                                                  log_level='INFO',
...
dmwd_red_3_twodspec = spectral_reduction.TwoDSpec(dmwd_red_3_image_reduction,
                                                  spatial_mask=spatial_mask,
                                                  spec_mask=spec_mask_red,
                                                  cosmic=True,
                                                  log_level='INFO',
...
dmwd_blue_1_twodspec = spectral_reduction.TwoDSpec(dmwd_blue_1_image_reduction,
                                                   spatial_mask=spatial_mask,
...
dmwd_blue_2_twodspec = spectral_reduction.TwoDSpec(dmwd_blue_2_image_reduction,
                                                   spatial_mask=spatial_mask,
                                                   spec_mask=spec_mask_blue,
                                                   cosmic=True,
                                                   log_level='INFO',
...
dmwd_blue_3_twodspec = spectral_reduction.TwoDSpec(dmwd_blue_3_image_reduction,
                                                   spatial_mask=spatial_mask,
                                                   spec_mask=spec_mask_blue,
                                                   cosmic=True,
                                                   log_level='INFO',
...
dmwd_blue_4_twodspec = spectral_reduction.TwoDSpec(dmwd_blue_4_image_reduction,
                                                   spatial_mask=spatial_mask,
                                                   spec_mask=spec_mask_blue,
                                                   cosmic=True,
                                                   log_level='INFO',
...
dmwd_red_1_twodspec.ap_extract(spec_id=[1],
                               apwidth=6,
                               skysep=[3, 15],
                               display=False)
dmwd_red_1_twodspec.ap_extract(spec_id=[2],
                               apwidth=6,
                               skysep=[15, 3],
                               display=False)
...
dmwd_red_2_twodspec.ap_extract(spec_id=[1],
                               apwidth=6,
                               skysep=[3, 15],
                               display=False)
dmwd_red_2_twodspec.ap_extract(spec_id=[2],
                               apwidth=6,
                               skysep=[15, 3],
                               display=False)
...
dmwd_red_3_twodspec.ap_extract(spec_id=[1],
                               apwidth=6,
                               skysep=[3, 15],
                               display=False)
dmwd_red_3_twodspec.ap_extract(spec_id=[2],
                               apwidth=6,
                               skysep=[15, 3],
                               display=False)
...
dmwd_blue_1_twodspec.ap_extract(spec_id=[1],
                                apwidth=6,
                                skysep=[3, 15],
                                display=False)
dmwd_blue_1_twodspec.ap_extract(spec_id=[2],
                                apwidth=6,
                                skysep=[15, 3],
                                display=False)
...
dmwd_blue_2_twodspec.ap_extract(spec_id=[1],
                                apwidth=6,
                                skysep=[3, 15],
                                display=False)
dmwd_blue_2_twodspec.ap_extract(spec_id=[2],
                                apwidth=6,
                                skysep=[15, 3],
                                display=False)
...
dmwd_blue_3_twodspec.ap_extract(spec_id=[1],
                                apwidth=6,
                                skysep=[3, 15],
                                display=False)
dmwd_blue_3_twodspec.ap_extract(spec_id=[2],
                                apwidth=6,
                                skysep=[15, 3],
                                display=False)
...
dmwd_blue_4_twodspec.ap_extract(spec_id=[1],
                                apwidth=6,
                                skysep=[3, 15],
                                display=False)
dmwd_blue_4_twodspec.ap_extract(spec_id=[2],
                                apwidth=6,
                                skysep=[15, 3],
                                display=False)
...
BDp253941_red_image_reduction.set_properties(cosmicray=False, psfmodel='gauss', gain='E_GAIN')
...
BDp253941_blue_image_reduction.set_properties(cosmicray=False,
                                              psfmodel='gauss', gain='E_GAIN')
...
dmwd_red_1_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                  log_file_name=None)
dmwd_red_1_onedspec.from_twodspec(dmwd_red_1_twodspec, stype='science')
dmwd_red_1_onedspec.from_twodspec(copy.copy(BDp253941_red_twodspec), stype='standard')

dmwd_red_2_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                  log_file_name=None)
dmwd_red_2_onedspec.from_twodspec(dmwd_red_2_twodspec, stype='science')
dmwd_red_2_onedspec.from_twodspec(copy.copy(BDp253941_red_twodspec), stype='standard')

dmwd_red_3_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                  log_file_name=None)
dmwd_red_3_onedspec.from_twodspec(dmwd_red_3_twodspec, stype='science')
dmwd_red_3_onedspec.from_twodspec(copy.copy(BDp253941_red_twodspec), stype='standard')

dmwd_blue_1_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                   log_file_name=None)
dmwd_blue_1_onedspec.from_twodspec(dmwd_blue_1_twodspec, stype='science')
dmwd_blue_1_onedspec.from_twodspec(copy.copy(BDp253941_blue_twodspec), stype='standard')

dmwd_blue_2_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                   log_file_name=None)
dmwd_blue_2_onedspec.from_twodspec(dmwd_blue_2_twodspec, stype='science')
dmwd_blue_2_onedspec.from_twodspec(copy.copy(BDp253941_blue_twodspec), stype='standard')

dmwd_blue_3_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                   log_file_name=None)
dmwd_blue_3_onedspec.from_twodspec(dmwd_blue_3_twodspec, stype='science')
dmwd_blue_3_onedspec.from_twodspec(copy.copy(BDp253941_blue_twodspec), stype='standard')

dmwd_blue_4_onedspec = spectral_reduction.OneDSpec(log_level='INFO',
                                                   log_file_name=None)
dmwd_blue_4_onedspec.from_twodspec(dmwd_blue_4_twodspec, stype='science')
dmwd_blue_4_onedspec.from_twodspec(copy.copy(BDp253941_blue_twodspec), stype='standard')

# Extract arc spectrum
dmwd_red_1_onedspec.find_arc_lines(prominence=1.,
                                   display=False,
                                   stype='science+standard')
dmwd_red_2_onedspec.find_arc_lines(prominence=1.,
                                   display=False,
                                   stype='science+standard')
dmwd_red_3_onedspec.find_arc_lines(prominence=1.,
                                   display=False,
                                   stype='science+standard')
dmwd_blue_1_onedspec.find_arc_lines(prominence=1.,
                                    display=False,
                                    stype='science+standard')
dmwd_blue_2_onedspec.find_arc_lines(prominence=1.,
                                    display=False,
                                    stype='science+standard')
dmwd_blue_3_onedspec.find_arc_lines(prominence=1.,
                                    display=False,
                                    stype='science+standard')
dmwd_blue_4_onedspec.find_arc_lines(prominence=1.,
                                    display=False,
                                    stype='science+standard')
...
dmwd_red_1_onedspec.set_hough_properties(num_slopes=5000,
                                         xbins=500,
                                         ybins=500,
                                         min_wavelength=5000,
                                         max_wavelength=10500,
                                         stype='science+standard')
dmwd_red_2_onedspec.set_hough_properties(num_slopes=5000,
                                         xbins=500,
                                         ybins=500,
                                         min_wavelength=5000,
                                         max_wavelength=10500,
                                         stype='science+standard')
dmwd_red_3_onedspec.set_hough_properties(num_slopes=5000,
                                         xbins=500,
                                         ybins=500,
                                         min_wavelength=5000,
                                         max_wavelength=10500,
...
dmwd_blue_1_onedspec.set_hough_properties(num_slopes=1000,
                                          xbins=100,
                                          ybins=100,
                                          min_wavelength=3000,
                                          max_wavelength=8500,
                                          stype='science+standard')
dmwd_blue_2_onedspec.set_hough_properties(num_slopes=1000,
                                          xbins=100,
                                          ybins=100,
                                          min_wavelength=3000,
                                          max_wavelength=8500,
                                          stype='science+standard')
dmwd_blue_3_onedspec.set_hough_properties(num_slopes=1000,
                                          xbins=100,
                                          ybins=100,
                                          min_wavelength=3000,
                                          max_wavelength=8500,
                                          stype='science+standard')
dmwd_blue_4_onedspec.set_hough_properties(num_slopes=1000,
                                          xbins=100,
                                          ybins=100,
                                          min_wavelength=3000,
                                          max_wavelength=8500,
...
dmwd_red_1_onedspec.set_ransac_properties(filter_close=True,
                                          stype='science+standard')
dmwd_red_2_onedspec.set_ransac_properties(filter_close=True,
                                          stype='science+standard')
dmwd_red_3_onedspec.set_ransac_properties(filter_close=True,
                                          stype='science+standard')
dmwd_blue_1_onedspec.set_ransac_properties(filter_close=True,
                                           stype='science+standard')
dmwd_blue_2_onedspec.set_ransac_properties(filter_close=True,
                                           stype='science+standard')
dmwd_blue_3_onedspec.set_ransac_properties(filter_close=True,
                                           stype='science+standard')
dmwd_blue_4_onedspec.set_ransac_properties(filter_close=True,
                                           stype='science+standard')
...
dmwd_red_1_onedspec.add_user_atlas(elements=elements,
                                   wavelengths=atlas,
                                   stype='science+standard')
dmwd_red_2_onedspec.add_user_atlas(elements=elements,
                                   wavelengths=atlas,
                                   stype='science+standard')
dmwd_red_3_onedspec.add_user_atlas(elements=elements,
                                   wavelengths=atlas,
                                   stype='science+standard')
...
dmwd_red_1_onedspec.fit(max_tries=2000, stype='science+standard', display=False)
dmwd_red_2_onedspec.fit(max_tries=2000, stype='science+standard', display=False)
dmwd_red_3_onedspec.fit(max_tries=2000, stype='science+standard', display=False)
dmwd_blue_1_onedspec.fit(max_tries=5000,
                         stype='science+standard',
                         display=False)
dmwd_blue_2_onedspec.fit(max_tries=5000,
                         stype='science+standard',
                         display=False)
dmwd_blue_3_onedspec.fit(max_tries=5000,
                         stype='science+standard',
                         display=False)
dmwd_blue_4_onedspec.fit(max_tries=5000,
                         stype='science+standard',
                         display=False)

# Apply the wavelength calibration and display it
dmwd_red_1_onedspec.apply_wavelength_calibration(wave_start=5500, wave_end=10000, wave_bin=1, stype='science+standard')
dmwd_red_2_onedspec.apply_wavelength_calibration(wave_start=5500, wave_end=10000, wave_bin=1, stype='science+standard')
dmwd_red_3_onedspec.apply_wavelength_calibration(wave_start=5500, wave_end=10000, wave_bin=1, stype='science+standard')
dmwd_blue_1_onedspec.apply_wavelength_calibration(wave_start=3500, wave_end=7950, wave_bin=1, stype='science+standard')
dmwd_blue_2_onedspec.apply_wavelength_calibration(wave_start=3500, wave_end=7950, wave_bin=1, stype='science+standard')
dmwd_blue_3_onedspec.apply_wavelength_calibration(wave_start=3500, wave_end=7950, wave_bin=1, stype='science+standard')
dmwd_blue_4_onedspec.apply_wavelength_calibration(wave_start=3500, wave_end=7950, wave_bin=1, stype='science+standard')

# Get the standard from the library
dmwd_red_1_onedspec.load_standard(target='BDp33d2642', library='irafirscal')
dmwd_red_2_onedspec.load_standard(target='BDp33d2642', library='irafirscal')
dmwd_red_3_onedspec.load_standard(target='BDp33d2642', library='irafirscal')
...
dmwd_red_1_onedspec.inspect_reduced_spectrum(wave_min=5500,
                                             wave_max=10000,
                                             display=False)
dmwd_red_2_onedspec.inspect_reduced_spectrum(wave_min=5500,
                                             wave_max=10000,
                                             display=False)
dmwd_red_3_onedspec.inspect_reduced_spectrum(wave_min=5500,
                                             wave_max=10000,
                                             display=False)
dmwd_blue_1_onedspec.inspect_reduced_spectrum(wave_min=3000,
                                              wave_max=8500,
                                              display=False)
dmwd_blue_2_onedspec.inspect_reduced_spectrum(wave_min=3000,
                                              wave_max=8500,
                                              display=False)
dmwd_blue_3_onedspec.inspect_reduced_spectrum(wave_min=3000,
                                              wave_max=8500,
                                              display=False)
dmwd_blue_4_onedspec.inspect_reduced_spectrum(wave_min=3000,
                                              wave_max=8500,
                                              display=False)

dmwd_red_1_onedspec.save_csv(output='wavelength+flux', filename='dmwd_red_1', overwrite=True)
dmwd_red_2_onedspec.save_csv(output='wavelength+flux', filename='dmwd_red_2', overwrite=True)
dmwd_red_3_onedspec.save_csv(output='wavelength+flux', filename='dmwd_red_3', overwrite=True)
dmwd_blue_1_onedspec.save_csv(output='wavelength+flux', filename='dmwd_blue_1', overwrite=True)
dmwd_blue_2_onedspec.save_csv(output='wavelength+flux', filename='dmwd_blue_2', overwrite=True)
dmwd_blue_3_onedspec.save_csv(output='wavelength+flux', filename='dmwd_blue_3', overwrite=True)
dmwd_blue_4_onedspec.save_csv(output='wavelength+flux', filename='dmwd_blue_4', overwrite=True)
...
flux_red_1 = dmwd_red_1_onedspec.science_spectrum_list[0].flux_resampled
flux_red_2 = dmwd_red_2_onedspec.science_spectrum_list[0].flux_resampled
flux_red_3 = dmwd_red_3_onedspec.science_spectrum_list[0].flux_resampled
flux_blue_1 = dmwd_blue_1_onedspec.science_spectrum_list[0].flux_resampled
flux_blue_2 = dmwd_blue_2_onedspec.science_spectrum_list[0].flux_resampled
flux_blue_3 = dmwd_blue_3_onedspec.science_spectrum_list[0].flux_resampled
flux_blue_4 = dmwd_blue_4_onedspec.science_spectrum_list[0].flux_resampled
...
flux_red_1 = dmwd_red_1_onedspec.science_spectrum_list[1].flux_resampled
flux_red_2 = dmwd_red_2_onedspec.science_spectrum_list[1].flux_resampled
flux_red_3 = dmwd_red_3_onedspec.science_spectrum_list[1].flux_resampled
flux_blue_1 = dmwd_blue_1_onedspec.science_spectrum_list[1].flux_resampled
flux_blue_2 = dmwd_blue_2_onedspec.science_spectrum_list[1].flux_resampled
flux_blue_3 = dmwd_blue_3_onedspec.science_spectrum_list[1].flux_resampled
flux_blue_4 = dmwd_blue_4_onedspec.science_spectrum_list[1].flux_resampled
...
flux_red_1 = dmwd_red_1_onedspec.science_spectrum_list[2].flux_resampled
flux_red_2 = dmwd_red_2_onedspec.science_spectrum_list[2].flux_resampled
flux_red_3 = dmwd_red_3_onedspec.science_spectrum_list[2].flux_resampled
flux_blue_1 = dmwd_blue_1_onedspec.science_spectrum_list[2].flux_resampled
flux_blue_2 = dmwd_blue_2_onedspec.science_spectrum_list[2].flux_resampled
flux_blue_3 = dmwd_blue_3_onedspec.science_spectrum_list[2].flux_resampled
flux_blue_4 = dmwd_blue_4_onedspec.science_spectrum_list[2].flux_resampled
