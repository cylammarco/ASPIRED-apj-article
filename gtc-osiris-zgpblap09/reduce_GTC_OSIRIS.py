...
bias_1 = "bias/0002673108-20200913-OSIRIS-OsirisBias.fits.gz"
bias_2 = "bias/0002673110-20200913-OSIRIS-OsirisBias.fits.gz"
bias_3 = "bias/0002673111-20200913-OSIRIS-OsirisBias.fits.gz"
bias_4 = "bias/0002673112-20200913-OSIRIS-OsirisBias.fits.gz"
bias_5 = "bias/0002673114-20200913-OSIRIS-OsirisBias.fits.gz"
bias_6 = "bias/0002673115-20200913-OSIRIS-OsirisBias.fits.gz"
bias_7 = "bias/0002673116-20200913-OSIRIS-OsirisBias.fits.gz"
bias_8 = "bias/0002673117-20200913-OSIRIS-OsirisBias.fits.gz"
bias_9 = "bias/0002673118-20200913-OSIRIS-OsirisBias.fits.gz"
bias_10 = "bias/0002673119-20200913-OSIRIS-OsirisBias.fits.gz"
bias_11 = "bias/0002673120-20200913-OSIRIS-OsirisBias.fits.gz"

light_r1000b_1 = (
    "object/0002673185-20200913-OSIRIS-OsirisLongSlitSpectroscopy.fits.gz"
)
light_r1000b_2 = (
    "object/0002673186-20200913-OSIRIS-OsirisLongSlitSpectroscopy.fits.gz"
)

standard_r1000b = (
    "stds/0002673244-20200913-OSIRIS-OsirisLongSlitSpectroscopy.fits.gz"
)

flat_r1000b_1 = "flat/0002672527-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"
flat_r1000b_2 = "flat/0002672528-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"
flat_r1000b_3 = "flat/0002672530-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"
flat_r1000b_4 = "flat/0002672533-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"

hgar_r1000b = "arc/0002672524-20200911-OSIRIS-OsirisCalibrationLamp.fits.gz"
ne_r1000b_1 = "arc/0002672525-20200911-OSIRIS-OsirisCalibrationLamp.fits.gz"
ne_r1000b_2 = "arc/0002672526-20200911-OSIRIS-OsirisCalibrationLamp.fits.gz"
...
science_1_twodspec = spectral_reduction.TwoDSpec(
    ...
    saxis=0,
    log_file_name="R1000B_1_twodspec.log",
    log_level="INFO",
)
...
science_2_twodspec = spectral_reduction.TwoDSpec(
    ...
    spatial_mask=spatial_mask,
    saxis=0,
    log_file_name="R1000B_2_twodspec.log",
    log_level="INFO",
)
...
science_1_onedspec = spectral_reduction.OneDSpec(
    log_file_name="R1000B_1_onedspec.log", log_level="INFO"
)
...
science_2_onedspec = spectral_reduction.OneDSpec(
    log_file_name="R1000B_2_onedspec.log", log_level="INFO"
)
...
science_1_onedspec.fit(max_tries=2000, fit_deg=4, stype="science+standard")
...
science_1_onedspec.get_sensitivity(
    k=3, method="interpolate", mask_fit_size=1, lowess_frac=0.02
)
...
# Solve for the pixel-to-wavelength solution
science_2_onedspec.fit(max_tries=2000, fit_deg=4, stype="science+standard")
...
light_r2500u_1 = (
    "object/0002673193-20200913-OSIRIS-OsirisLongSlitSpectroscopy.fits.gz"
)
light_r2500u_2 = (
    "object/0002673194-20200913-OSIRIS-OsirisLongSlitSpectroscopy.fits.gz"
)

standard_r2500u = (
    "stds/0002673245-20200913-OSIRIS-OsirisLongSlitSpectroscopy.fits.gz"
)

flat_r2500u_1 = "flat/0002672538-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"
flat_r2500u_2 = "flat/0002672539-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"
flat_r2500u_3 = "flat/0002672540-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"
flat_r2500u_4 = "flat/0002672541-20200911-OSIRIS-OsirisSpectralFlat.fits.gz"

hgar_r2500u = "arc/0002672534-20200911-OSIRIS-OsirisCalibrationLamp.fits.gz"
xe_r2500u = "arc/0002672535-20200911-OSIRIS-OsirisCalibrationLamp.fits.gz"
xe_r2500u = "arc/0002672536-20200911-OSIRIS-OsirisCalibrationLamp.fits.gz"
...
science_r2500u_1_twodspec = spectral_reduction.TwoDSpec(
    ...
    saxis=0,
    log_file_name="R2500U_1_twodspec.log",
    log_level="INFO",
)
...
science_r2500u_1_onedspec = spectral_reduction.OneDSpec(
    log_file_name="R2500U_1_onedspec.log", log_level="INFO"
)
...
science_r2500u_2_onedspec = spectral_reduction.OneDSpec(
    log_file_name="R2500U_2_onedspec.log", log_level="INFO"
)
...
# Solve for the pixel-to-wavelength solution
science_r2500u_2_onedspec.fit(max_tries=1000, stype="science+standard")
...
# Make plot here
Egr = 0.81
Ebv_correction_multiplier = 0.981
Rv = 3.1
...
ext_bin1 = extinction.fm07(wave_1, Egr * Ebv_correction_multiplier * Rv)
ext_bin2 = extinction.fm07(wave_1_bin2, Egr * Ebv_correction_multiplier * Rv)
ext_bin5 = extinction.fm07(wave_1_bin5, Egr * Ebv_correction_multiplier * Rv)
...
# Get the interstellar dust extinction correction
ext_r2500u_bin1 = extinction.fm07(
    wave_r2500u_1, Egr * Ebv_correction_multiplier * Rv
)
ext_r2500u_bin2 = extinction.fm07(
    wave_r2500u_1_bin2, Egr * Ebv_correction_multiplier * Rv
)
ext_r2500u_bin5 = extinction.fm07(
    wave_r2500u_1_bin5, Egr * Ebv_correction_multiplier * Rv
)
...
ax2.plot(
    wave_1_bin2,
    extinction.remove(
        ext_bin2, np.nanmean((flux_1_bin2, flux_2_bin2), axis=0)
    ),
    color="0.2",
...
np.save(
    "r1000b_1.npy",
    np.column_stack((wave_1_bin2, extinction.remove(ext_bin2, flux_1_bin2))),
)
np.save(
    "r1000b_2.npy",
    np.column_stack((wave_1_bin2, extinction.remove(ext_bin2, flux_2_bin2))),
)
