...
This paper is organised as follows: Section \textsection2 covers the development and
...
event AT 2017gfo\footnote{\url{https://www.wiserep.org/}}. Las Cumbres
...
lines is used as an example for comparison. The Liverpool Telescope/SPRAT is a
...
four individual exposures. The Very Large Telescope/FORS2 data of a helium
accretor~(AM CVn) V418 Ser stacked from 21 individual exposures is used as our
last comparison. The first three were compared against data reduction from
\textsc{iraf}-based pipelines, while the last one is reduced with Molly, which
...
simultaneous tracing followed by sequential extraction of the pair of spectra
incidented on the long-slit in one exposure. The GTC/OSIRIS works on a BLAP
with many resolved absorption lines in both the science and the standard
target.
