...
(ii)~the peak\,(pixel)--line\,(wavelength) pairs and the constrained parameter
space where the Hough pairs are selected~(see \citealt{2020ASPC..527..627V});
...
%This process is used after the smoothing procedure~(if performed).
...
\textsc{ASPIRED}, instead, the correction was done by directly accessing the
